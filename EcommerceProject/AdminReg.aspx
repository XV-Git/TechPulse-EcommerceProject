<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.Master" AutoEventWireup="true" CodeBehind="AdminReg.aspx.cs" Inherits="EcommerceProject.AdminReg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td colspan="2">
            <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="Large" Text="Admin Registration Page"></asp:Label>
        </td>
    ...
    <tr>
        ...
        <td class="auto-style21">
            <asp:Button ID="Button1" runat="server" Text="Register" BackColor="#0033CC" ForeColor="White" OnClick="Button1_Click" CssClass="btn" />
        </td>
        <td colspan="2">
            <asp:Label ID="Label7" runat="server" Text="Label" Visible="False" Font-Bold="True"></asp:Label>
        </td>
        <td class="auto-style15">
            <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/LoginGen.aspx" BackColor="#0033CC" ForeColor="White" Visible="False" BorderStyle="Solid" CssClass="btn">Back to Login</asp:LinkButton>
        </td>
        <td class="auto-style7">&nbsp;</td>
    </tr>
    <tr>
